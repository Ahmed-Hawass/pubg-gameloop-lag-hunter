...
export const ar = {
  ...
  dialog: {
    ...
    firstRunAdviceBody:
      "شغّل GameLoop واللعبة أولًا ثم اضغط زر البدء، وابقَ داخل اللعبة أثناء الفحص. تصغير نافذة GameLoop يوقف مراقبة كرت الشاشة مؤقتًا، وإغلاقه ينهي الفحص.",
  },
  ...
  highlights: {
    ...
    mostly_background: "قُضيت معظم هذه الجلسة خارج اللعبة — قد لا تعكس النتائج مباراة حقيقية.",
  } as Record<string, string>,
  ...
  welcomeWhat: "حلّل أداء PUBG Mobile على GameLoop، ارصد التقطيعات، واكشف سببها الحقيقي بدقة.",
  ...
  // ---- system checks tab ----
  checksHint: "فحوصات قراءة فقط لإعدادات تسبب التقطيع بصمت. لا نغيّر شيئًا عنك — كل إصلاح يفتح صفحة إعدادات ويندوز المعنية لتغيّرها بنفسك.",
  ...
  aboutWhat: "حلّل أداء PUBG Mobile على GameLoop، ارصد التقطيعات، واكشف سببها الحقيقي بدقة.",
  ...
  disk: "القرص",
  cpuHint:
    "نسبة استخدام المعالج. يُعد الارتفاع طبيعيًا أثناء قيام GameLoop بترجمة اللعبة، أما الاستمرار فوق 95% مع حدوث تقطيع فهذا يعني أن المعالج غير كافٍ.",
  ramHint:
    "الذاكرة المستخدمة. عند امتلائها تبدأ اللعبة في نقل الملفات إلى القرص، وكل عملية نقل تسبب تقطيعًا.",
  gpuHint:
    "نسبة استخدام كرت الشاشة أثناء الرسم. قد تشير القيم المنخفضة خلال المباراة إلى تقطيعات ناتجة عن وضع توفير الطاقة.",
  diskHint:
    "نشاط القرص. ترتفع القيم أثناء النزول إلى الخريطة كتحميل طبيعي، أما الاستمرار عند 100% مع حدوث تقطيع فهذا يعني عاصفة ترقيم صفحات.",
  ...
  gameBackground: "نافذة اللعبة في الخلفية — مراقبة كرت الشاشة متوقفة مؤقتًا حتى عودتك إليها",
