...
export const ar: Locale = {
  ...
  highlights: {
    ...
    render_stall: "تم رصد تجميد في الإطارات",
    render_stall_loaded: "تجميد في الإطارات مع حمل عالٍ",
  ...
  gameBackground: "نافذة اللعبة في الخلفية، لذا مراقبة كرت الشاشة متوقفة مؤقتًا حتى عودتك إليها",
