...
export const ar: Locale = {
  ...
  dialog: {
    ...
    gameAdviceBody:
      "أغلق التطبيقات التي تعمل في الخلفية قبل اللعب؛ فالمتصفحات والتنزيلات وبرامج المحادثة تنافس اللعبة على المعالج، وقد يظهر أي منها في النتائج كسبب للتقطيع. تظهر هذه النصيحة مرة واحدة فقط.",
  },
